...
1. Fork the project by navigating to the main [repository](https://github.com/carbon-design-system/carbon-design-system) and clicking the **Fork** button on the top-right corner.

2. Navigate to your forked repository and copy the **SSH url**. Clone your fork by running the following in your terminal:

   ```
   $ git clone git@github.com:{ YOUR_USERNAME }/carbon-design-system.git
...
3. Once cloned, you will see `origin` as your default remote, pointing to your personal forked repository. Add a remote named `upstream` pointing to the main `carbon-design-system`:

   ```
   $ git remote add upstream git@github.com:carbon-design-system/carbon-design-system.git
   $ git remote -v
   ```
...
8. In Github, navigate to [carbon-design-system/carbon-design-system](https://github.com/carbon-design-system/carbon-design-system) and click the button that reads "Compare & pull request".
